...
// The minimum required platform is the earliest version of Windows, Internet Explorer, etc. that has
// the necessary features to run your application. The macros work by enabling all features available
